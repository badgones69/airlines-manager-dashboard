...
export function getAircraftFlightDepartureTimeInputLabel(): string {
  return 'DÉPART';
}
...
export function getAircraftFlightsErrorNotificationMessage(): string {
  return `Les horaires de vos vols sont incohérents !`;
}
