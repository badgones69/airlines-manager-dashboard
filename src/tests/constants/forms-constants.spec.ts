...
import { ADD_FORM_MODE, EDIT_FORM_MODE, DELETE_FORM_MODE, IDENTITY_PATTERN, LOGIN_PATTERN, PASS_WORD_PATTERN, ICAO_IATA_CODE_PATTERN, REQUIRED_ERROR, BLANK_VALUE_ERROR, MIN_LENGTH_ERROR, MAX_LENGTH_ERROR, PATTERN_ERROR, NOT_IDENTICAL_PASS_WORD_ERROR, UNKNOWN_COUNTRY_ERROR } from '../../app/shared/constants/forms-constants';
