...
} from '../../app/shared/utils/labels-utils';
...
describe('LabelsUtils', () => {
  ...
  it('#capitalizeFirstLetter should return word with first letter capitalized', () => {
    const firstLetterCapitalizedWord: string =
  ...
  it('#capitalizeSpaceSeparatedWordsFirstLetter should return space-separated words with first letter capitalized', () => {
    const firstLetterCapitalizedSpaceSeparatedWords: string =
      capitalizeSpaceSeparatedWordsFirstLetter('wolfgang amadeus');
    expect(firstLetterCapitalizedSpaceSeparatedWords).toStrictEqual(
      'Wolfgang Amadeus',
    );
  });

  it('#capitalizeDashedWordsFirstLetter should return dashed words with first letter capitalized', () => {
    const firstLetterCapitalizedDashedWords: string =
      capitalizeDashedWordsFirstLetter('franz-josef');
